...
class Model(object):
    ...
    def __init__(self):
        ...
        self.gp_kernel = Matern(nu=0.5, length_scale=1.0)
        self.gp_model = GaussianProcessRegressor(kernel=self.gp_kernel, optimizer='fmin_l_bfgs_b', random_state=None,
    ...
    def make_predictions(self, test_x_2D: np.ndarray, test_x_AREA: np.ndarray) -> typing.Tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        gp_mean, gp_std = self.gp_model.predict(test_x_2D, return_std=True)
    ...
    def fitting_model(self, train_y: np.ndarray,train_x_2D: np.ndarray):
        ...
        self.gp_model.fit(train_x_2D, train_y)
        pass
